...
AAs = []
tng_df = pd.read_csv(abs_path + 'training/DPB1_train.csv')
tst_df = pd.read_csv(abs_path + 'testing/DPB1_test.csv')
val_df = pd.read_csv(abs_path + 'training/DPB1_validation.csv')
tng_idx = len(tng_df)
...
output_preds.to_csv(abs_path + 'predictions/DPB1_predictions.csv', index=False)
