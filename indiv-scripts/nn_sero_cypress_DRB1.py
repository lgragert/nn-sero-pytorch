...
AAs = []
tng_df = pd.read_csv(abs_path + 'training/DRB1_train.csv')
tst_df = pd.read_csv(abs_path + 'testing/DRB1_test.csv')
val_df = pd.read_csv(abs_path + 'training/DRB1_validation.csv')
tng_idx = len(tng_df)
...
output_preds.to_csv(abs_path + 'predictions/DRB1_predictions.csv', index=False)
