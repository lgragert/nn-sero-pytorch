...
AAs = []
tng_df = pd.read_csv(abs_path + 'training/DQB1_train.csv')
tst_df = pd.read_csv(abs_path + 'testing/DQB1_test.csv')
val_df = pd.read_csv(abs_path + 'training/DQB1_validation.csv')
tng_idx = len(tng_df)
...
output_preds.to_csv(abs_path + 'predictions/DQB1_predictions.csv', index=False)
