...
AAs = []
tng_df = pd.read_csv(abs_path + 'training/B_train.csv')
tst_df = pd.read_csv(abs_path + 'testing/B_test.csv')
val_df = pd.read_csv(abs_path + 'training/B_validation.csv')
tng_idx = len(tng_df)
...
output_preds.to_csv(abs_path + 'predictions/B_predictions.csv', index=False)
