...
def _file_handler(abs_path):
    ...
    for locus in loci:
        ...
        training_file = open(abs_path + 'pat_old/' + locus + ".tng.pat", 'r')
        testing_file = open(abs_path + 'pat_old/' + locus + ".tst.pat", 'r')
        validation_file = open(abs_path + 'pat_old/' + locus + ".val.pat", 'r')
        ...
        tng_frame.to_csv(abs_path + 'old_sets/train/' + locus + '_train.csv', index=False)
        val_frame.to_csv(abs_path + 'old_sets/train/' + locus + '_validation.csv', index=False)
        tst_frame.to_csv(abs_path + 'old_sets/test/' + locus + '_test.csv', index=False)
        training_file.close()
        testing_file.close()
...
_file_handler('/lustre/project/lgragert/gbiagini/dev/nn-sero-pytorch/')
