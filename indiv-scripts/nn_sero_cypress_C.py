...
AAs = []
tng_df = pd.read_csv(abs_path + 'training/C_train.csv')
tst_df = pd.read_csv(abs_path + 'testing/C_test.csv')
val_df = pd.read_csv(abs_path + 'training/C_validation.csv')
tng_idx = len(tng_df)
...
output_preds.to_csv(abs_path + 'predictions/C_predictions.csv', index=False)
