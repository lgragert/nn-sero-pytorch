...
abs_path = '/lustre/project/lgragert/gbiagini/nn-sero-pytorch/'
...
for locus in loci:
  AAs = []
  tng_df = pd.read_csv(abs_path + 'training/' + locus + '_train.csv')
  tst_df = pd.read_csv(abs_path + 'testing/' + locus + '_test.csv')
  val_df = pd.read_csv(abs_path + 'training/' + locus + '_validation.csv')
  tng_idx = len(tng_df)
  ...
  output_preds.to_csv(abs_path + 'predictions/' + locus + '_predictions.csv', index=False)
